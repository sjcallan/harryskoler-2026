...
watch(() => props.open, (open) => {
    if (open) {
        activeIndex.value = props.startIndex ?? 0;
...
function prev() {
    goTo(activeIndex.value <= 0 ? props.images.length - 1 : activeIndex.value - 1);
}

function next() {
    goTo(activeIndex.value >= props.images.length - 1 ? 0 : activeIndex.value + 1);
}
...
<template>
    <Teleport to="body">
        <Transition name="lightbox-fade">
            <div v-if="open && images.length" class="lightbox-overlay" @click.self="close">
                ...
                <div class="lightbox-main">
                    ...
                    <div class="lightbox-meta">
                        <div class="lightbox-meta-text">
                            ...
                            <h3 class="lightbox-caption">{{ images[activeIndex].caption }}</h3>
                            <p v-if="images[activeIndex].credit" class="lightbox-credit">{{ images[activeIndex].credit }}</p>
                        </div>
                        <a
                            :href="images[activeIndex].full"
                            target="_blank"
                            rel="noopener"
